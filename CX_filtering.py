...
if __name__ == "__main__":
    ...
    ext_data = extract_context(input_file, write_to_output=args.writeExtractedOutput, context=c_context)
    bin_cx_data(ext_data, filename, c_context, bin_size=bin_size)
